                    ...
                    <tr key={index}>
                        ...
                        <td>
                            ...
                            <button className="btn-accion" onClick={() => {
                                ...
                                <img src="/public/borrar.png" alt="Eliminar" className="icono-accion"/>
                            </button>
                        </td>
                    </tr>
                ))}
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-info">
                            <div>
                                ...
                                <span>{selectedDescuento?.empleado?.persona?.nroDocumento}</span>
                            </div>
                            <div>
                                <label>Nombre:</label>
                                <span>{`${selectedDescuento?.empleado?.persona?.nombres || ""} ${selectedDescuento?.empleado?.persona?.apellidos || ""}`}</span>
                            </div>
                        </div>

                        <div className="modal-grid">
                            <label>Entradas Tardías
                                <input type="number" name="entradaTardia" value={selectedDescuento.entradaTardia} onChange={handleInputChange} />
                            </label>

                            <label>Salidas Anticipadas
                                <input type="number" name="salidaAnticipada" value={selectedDescuento.salidaAnticipada} onChange={handleInputChange} />
                            </label>

                            <label>Ausencias
                                <input type="number" name="ausencia" value={selectedDescuento.ausencia} onChange={handleInputChange} />
                            </label>

                            <label>Monto Descuento
                                <input type="number" name="monto" value={selectedDescuento.monto} onChange={handleInputChange} />
                            </label>
                        </div>
