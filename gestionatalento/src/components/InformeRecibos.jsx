...
const styles = StyleSheet.create({
    ...
    title: { textAlign: "center", fontSize: 11, fontWeight: "bold" },
    subtitle: { textAlign: "center", fontSize: 10, marginBottom: 4 },
    personaLabel: {
        textAlign: "center",
        fontSize: 9,
        marginBottom: 8,
    ...
    tableHeader: { backgroundColor: "#d9d9d9", fontWeight: "bold" },
    tableCell: {
        padding: 2,
        borderRightWidth: 1,
        borderBottomWidth: 1,
